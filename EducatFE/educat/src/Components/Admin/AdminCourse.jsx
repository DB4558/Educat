            ...
            <div className="main-content">
                ...
                <div className="domain-container">
                    <div className="domain-btn-container">
                        <button className="domain-btn-add" onClick={() => navigate('/addCourse')}>Add Course</button>
                    </div>
                    <div className="domain-btn-container">
                        <button className="domain-btn-view" onClick={() => navigate('/viewCourse')}>View Course</button>
                    </div>
                </div>
            </div>
        </>
